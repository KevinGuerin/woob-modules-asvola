...
from .browser import TelecoopBrowser

__all__ = ["TelecoopModule"]


class TelecoopModule(Module, CapDocument):
    NAME = "telecoop"
    DESCRIPTION = "TeleCoop — Opérateur télécom coopératif"
